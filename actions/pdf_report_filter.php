...
$mpdf->setFooter('<div style="font-family: sarabun, sans-serif; font-size: 14pt;">{PAGENO} / {nbpg}</div>');
        ...
        <table class="report-header">
            <tr>
                <td width="70%">
                    ...
                    <p><b>ตัวกรอง:</b>
                        <?= htmlspecialchars($faculty ?: 'ทั้งหมด') ?> / <?= htmlspecialchars($program ?: 'ทั้งหมด') ?> /
                        <?= htmlspecialchars($major ?: 'ทั้งหมด') ?> / <?= htmlspecialchars($province ?: 'ทั้งหมด') ?> /
                        <?= htmlspecialchars($academicYear ?: 'ทั้งหมด') ?>
                    </p>
                </td>
                <td>
